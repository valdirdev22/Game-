...
const imagens = ['./img/carinha_De_anjo.jpg', './img/carrossel_1.jpg', 
'./img/cirilo.jpg', './img/mosca.jpg', './img/poliana_1.jpg', 
'./img/poliana_2.jpg'];
 
for (let i = 1; i <= 8; i++) imagens.push(`../Joguinho_Manu/id/${i}/100`);
 
let fundo = `./img/Capa_1.jpg`;
...
onload = () => {
    ...
    document.body.style.backgroundImage = "url('./img/Praia_Bahia_1.jpg')";
};
...
const inicioJogo = () => {
  ...
  // Reinicia o estado do jogos
    ...
    document.body.style.backgroundImage = "url('./img/praia_manu.jpg')";
...
temCartaVirada = false;
 ...
 if(pontos == 6) {
    ...
    document.querySelector('.titulo').textContent ='Parabéns MANU!';
